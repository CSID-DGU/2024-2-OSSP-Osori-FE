...
> 아코밍(Akoming)은 대학생들의 교내외 활동을 효과적으로 관리하고 기록할 수 있는 통합 포트폴리오 관리 서비스입니다. 현재 대학생들의 다양한 활동을 체계적으로 관리할 수 있는 적절한 서비스가 부족한 상황에서, 저학년부터 고학년까지의 활동을 체계적으로 관리하고 이를 취업 준비에 활용할 수 있도록 돕는 것이 목표입니다. '아코(Ako)'와 'Coming'의 합성어인 프로젝트명은 '성장하는 아코가 온다'는 의미를 담고 있으며, 지속적으로 성장하는 코끼리를 모티브로 하여 동국대학교 학생들의 성장 관리 도구로 자리매김하고자 합니다.
